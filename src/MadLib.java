public class MadLib {
    ...
    public MadLib(){
        ...
        String classmate= "myDorm";
        System.out.println("myDorm");
        String city= "Plymouth";
        System.out.println("Plymouth");
        String noun = "Water";
        System.out.println("Water");
        String adjective= ("nice");
        System.out.println("nice");
        String pluralNoun= "Bags";
        System.out.println("Bags");
        String pluralAnimal=("Bears");
        System.out.println("Bears");
        String trueOrFalse=("True");
        System.out.println("True");
        Float decimalBiggerThan1 =(95.6f);
        System.out.println(95.6f);
        final int number1;
        number1=5;
        ...
        String miltonTeacher =("Mr.Jordan");
        System.out.println("Mr.Jordan");
        String miltonDean=("Mr.Ruiz");
        System.out.println("Mr.Ruiz");
        int letterGrade;
        letterGrade=100;
